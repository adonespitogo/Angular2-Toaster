...
var TestComponentModule = (function () {
...
exports.TestComponentModule = TestComponentModule;
...
exports.TestDynamicComponent = TestDynamicComponent;
var TestDynamicComponentModule = (function () {
    function TestDynamicComponentModule() {
    }
    TestDynamicComponentModule = __decorate([
        core_1.NgModule({
    ...
    return TestDynamicComponentModule;
}());
exports.TestDynamicComponentModule = TestDynamicComponentModule;
var TestBoundDynamicComponent = (function () {
    function TestBoundDynamicComponent() {
        this.someValue = 'Some value';
    }
    TestBoundDynamicComponent = __decorate([
        core_1.Component({
            selector: 'bound-dynamic-component',
            template: "<div>{{someValue}} loaded via component</div>"
        }), 
        __metadata('design:paramtypes', [])
    ], TestBoundDynamicComponent);
    return TestBoundDynamicComponent;
}());
exports.TestBoundDynamicComponent = TestBoundDynamicComponent;
var TestBoundDynamicComponentModule = (function () {
    function TestBoundDynamicComponentModule() {
    }
    TestBoundDynamicComponentModule = __decorate([
        core_1.NgModule({
    ...
    return TestBoundDynamicComponentModule;
}());
exports.TestBoundDynamicComponentModule = TestBoundDynamicComponentModule;
describe('ToasterContainerComponent with sync ToasterService', function () {
    ...
    it('should pop toast asynchronously', function () {
        ...
        var toasterContainer = fixture.debugElement.children[0].componentInstance;
        var toasterService = fixture.componentInstance.toasterService;
    ...
    it('removeToast notifies the removeToast subscribers', function (done) {
        toasterContainer.ngOnInit();
        var toast = { type: 'info', title: 'default' };
        toasterService.pop(toast);
        toasterService.removeToast.subscribe(function (t) {
...
describe('ToasterContainerComponent when included as a component', function () {
    ...
    beforeEach(function () {
        testing_1.TestBed.configureTestingModule({
            declarations: [TestComponent],
            imports: [toaster_module_1.ToasterModule, TestDynamicComponentModule]
        });
        fixture = testing_1.TestBed.createComponent(TestComponent);
    });
    ...
    it('addToast should render module if it exists', function () {
        fixture.detectChanges();
        var container = fixture.debugElement.children[0].componentInstance;
        var toast = {
            type: 'success',
...
describe('ToasterContainerComponent when included as a component with bindings', function () {
    var fixture;
    beforeEach(function () {
        testing_1.TestBed.configureTestingModule({
            declarations: [TestComponent],
            imports: [toaster_module_1.ToasterModule, TestBoundDynamicComponentModule]
        });
        fixture = testing_1.TestBed.createComponent(TestComponent);
    });
    it('should use the bound toasterconfig object if provided', function () {
    ...
    it('should redner the dynamic bound content', function () {
        fixture.detectChanges();
        var container = fixture.debugElement.children[0].componentInstance;
        var toast = {
            type: 'success',
